...
func TestAdd(t *testing.T) {
	...
	if l[0].Task != taskName {
		t.Errorf("Expected task name to be %q, got %q instead.", taskName, l[0].Task)
	}
}
...
func TestDelete(t *testing.T) {
	...
	if l[0].Task != tasks[0] {
		t.Errorf("Expected task name to be %q, got %q instead.", tasks[0], l[0].Task)
	}
	err := l.Delete(2)
	if err != nil {
	...
	if l[1].Task != tasks[2] {
		t.Errorf("Expected task name to be %q, got %q.", tasks[2], l[1].Task)
	}
}
...
func TestSaveGet(t *testing.T) {
	...
	if l1[0].Task != taskName {
		t.Errorf("Expected task name to be %q, got %q instead.", taskName, l1[0].Task)
	}
